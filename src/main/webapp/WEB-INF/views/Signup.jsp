      ...
      <div class="card card-outline card-primary">
        <div class="card-header">
          <a
            ...
            <h1 class="mb-0"><b>SignUp</b></h1>
          </a>
        </div>
        <div class="card-body register-card-body">
          <p class="register-box-msg">Register for New User</p>
          <form action="saveuser" method="post">
            ...
            <!-- Last Name -->
             <div class="input-group mb-1">
                <div class="form-floating">
                  <input id="lastName" type="text" class="form-control" placeholder="" name="lastName" />
...
<!--                 <div class="input-group-text"><span class="bi bi-person-fill"></span></div> -->
            ...
            <div class="input-group mb-1">
                <div class="form-floating">
                  <select id="gender" name="gender" class="form-control form-select" placeholder="" required>
            ...
            <div class="input-group mb-1">
                <div class="form-floating">
                  <input id="bornYear" type="date" class="form-control" placeholder="" name="bornYear" />
                  <label for="bornYear">Date Of Birth</label>
                </div>
                <div class="input-group-text"><span class="bi bi-calendar-check-fill"></span></div>
              </div>

            <!-- Contact No. -->
            <div class="input-group mb-1">
                <div class="form-floating">
                  <input id="ContactNum" type="text" class="form-control" placeholder="" name="contactNum" />
