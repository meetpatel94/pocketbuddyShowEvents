          ...
          <form action="sendOtp" method="post">
            ...
            <div class="input-group mb-1">
              <div class="form-floating">
                <input id="loginEmail" type="text" class="form-control" value="" placeholder="" name="otp"/>
            ...
            <div class="input-group mb-1">
              ...
              <div class="input-group-text"><span class="bi bi-file-lock2-fill"></span></div>
            </div>

            <!-- Confirm Password -->
            <div class="input-group mb-1">
              <div class="form-floating">
                <input id="loginPassword" type="password" class="form-control" placeholder="" name="confirmPassword" />
